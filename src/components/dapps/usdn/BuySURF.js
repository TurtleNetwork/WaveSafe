...
export default class BuySURF extends React.Component {
    ...
    async signTransaction() {
        ...
        if (config.network === 'Testnet') {
            dApp = '3N5NAftzfcw3gAt8nc35bNr9UdPTVgC81fd'
        } else {
            dApp = '3PG2vMhK5CPqsCDodvLGzQ84QkoHXCJ3oNP';
        }
        ...
        try {
            ...
            var invocation = { senderPublicKey: senderPublicKey, sender: sender, dApp: dApp, payment: payments, call: { function: 'buySurf', args: args } };
            var signer;
            if (config.provider === '') {
                signer = new Signer();
                ...
                <div className="col-xl-12 col-xxl-12">
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">Buy NSBT</h4>
                        </div>
                        <div className="card-body">
                            ...
                            >
                                ...
                                <label className="text-label">Amount of Waves to sell</label>
                                <input
                                    type="text"
                                    name="smartContract"
                                    className="form-control"
                                    onChange={ (event) => { this.amountWavesChanged(event); } }
                                    required
                                />
                                <br />
