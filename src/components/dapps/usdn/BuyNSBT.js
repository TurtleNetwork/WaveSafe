...
export default class BuyNSBT extends React.Component {
    ...
    async signTransaction() {
        ...
        try {
            ...
            var invocation = { senderPublicKey: senderPublicKey, sender: sender, dApp: dApp, payment: payments, call: { function: 'buyNsbt', args: [] } };
            var signer;
            if (config.provider === '') {
                signer = new Signer();
