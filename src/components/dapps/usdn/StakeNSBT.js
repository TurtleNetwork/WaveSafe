...
export default class StakeNSBT extends React.Component {
    ...
    async signTransaction() {
        ...
        if (config.network === 'Testnet') {
            ...
            nsbtAssetId = 'F3iaxzruFeKujfVfYSZEkejpjh67wmRfPCRHiNmWKp3Z';
        } else {
            dApp = '3P8w8NXZUtYdCA13tHbDY5sW4mC27ZFJgG3';
            nsbtAssetId = '6nSpVyNH7yM69eg446wrQR94ipbbcmZMU1ENPwanC97g';
        }
