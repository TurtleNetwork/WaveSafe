...
export default class BuyUSDN extends React.Component {
    ...
    async signTransaction() {
        ...
        if (config.network === 'Testnet') {
            dApp = '3N9be2mwrA52WJho6DiesZkk4351GvpnWuj'
        } else {
        ...
        try {
            ...
            var invocation = { senderPublicKey: senderPublicKey, sender: sender, dApp: dApp, payment: payments, call: { function: 'swapWavesToNeutrino', args: [] } };
            var signer;
            /*if (config.provider === '') {
                signer = new Signer();
                ...
                <div className="col-xl-12 col-xxl-12">
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">Buy USDN</h4>
                        </div>
