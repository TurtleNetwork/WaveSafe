...
export default class Type9TransactionRepresentation extends React.Component {
                ...
                <div className="col-xl-12 col-xxl-12">
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">Lease cancel transaction to sign</h4>
                        </div>
                        <div className="card-body">
                            <Table responsive>
                                ...
                                <tbody>
                                    ...
                                    <tr key="1">
                                        <td>Lease id to cancel</td>
                                        <td>{ this.state.tx.leaseId }</td>
                                    </tr>
                                </tbody>
                            </Table>
                            <br />
