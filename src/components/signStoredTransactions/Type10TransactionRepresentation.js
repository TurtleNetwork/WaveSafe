...
export default class Type10TransactionRepresentation extends React.Component {
    ...
    async signTransaction() {
        try {
            ...
            const aliasTransaction = await signer.alias(this.state.tx).sign();
            aliasTransaction.id = oldId;
            this.setState({ signedTransaction: aliasTransaction, showSignedTransaction: true });
        } catch(err) { }
    };
                ...
                <div className="col-xl-12 col-xxl-12">
                    <div className="card">
                        <div className="card-header">
                            <h4 className="card-title">Aliasn</h4>
                        </div>
